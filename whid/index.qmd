...
[**G. Domènech Arumí**](https://sites.google.com/site/domenechweb/home) (VanderbiltU) is a co-founder and collaborator in this project and he gratefully acknowledges funding and logistic support from the **Fonds Thiepolam** ([Fondation ULB](https://www.fondationulb.be/en/)).

[**Update (April 2025):**]{style="color: red;"}

-   The data for Belgium is ready and available [here](https://dataverse.harvard.edu/citation?persistentId=doi:10.7910/DVN/FUQBWG).
...
-   The data for Spain is ready and available [here](https://doi.org/10.7910/DVN/HONBNB).
...
-   The data for the United States is ready and available [here](https://dataverse.harvard.edu/citation?persistentId=doi:10.7910/DVN/5C9AJD).
-   See this [paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5928399) for details about the United States data.

[**Update (January 2026):**]{style="color: red;"}

-   The WHID now has a dedicated website with interactive maps and other resources.
-   [Link](https://www.worldhousingdata.com/) 
