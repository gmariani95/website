...
[**G. Domènech Arumí**](https://sites.google.com/site/domenechweb/home) (VanderbiltU) is a co-founder and collaborator in this project.

[**G. Domènech Arumí**](https://sites.google.com/site/domenechweb/home) gratefully acknowledges funding and logistic support from the **Fonds Thiepolam** ([Fondation ULB](https://www.fondationulb.be/en/)).

[**Update (April 2025):**]{style="color: red;"}

-   The data for Belgium is already publicly available [here](https://dataverse.harvard.edu/citation?persistentId=doi:10.7910/DVN/FUQBWG).
-   See this [paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4588122) for details about the Belgian data.

[**Update (October 2025):**]{style="color: red;"}

-   The data for Spain is already publicly available [here](https://doi.org/10.7910/DVN/HONBNB).
-   See this [paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5688222) for details about the Spanish data.


[**Update (December 2025):**]{style="color: red;"}

-   The data for the United States is already publicly available [here](https://dataverse.harvard.edu/citation?persistentId=doi:10.7910/DVN/5C9AJD).
-   See this [paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5928399) for details about the United States data.
-   The WHID will be hosted in this URL: www.worldhousingdata.com (the link will become active in late November).
